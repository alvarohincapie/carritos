...
public class RequestPage {
	 ...
	 *
	 * @param showNoPlaca the new show no placa
	 */
	...
	public void action_openConfirmationRequest(ActionEvent actionEvent) {
		...
		try {
			...
			if (requestsClasses.longValue() == ParametersUtil.CLASE_ALQUILER.longValue()
					&& legateesTypes.longValue() != ParametersUtil.LGT_CONVENIO.longValue()
					&& (listCostsCentersRequests == null || listCostsCentersRequests.size() == 0))
	 ...
	 * Sets the show ofs.
	 *
	 * @param showOFS the new show ofs
	 */
	 ...
	 *
	 * @param showCostCenter the new show cost center
	 */
	 ...
	 *
	 * @param showTercero the new show tercero
	 */
	 ...
	 *
	 * @param sbCodigoCentroCosto the new sb codigo centro costo
	 */
	 ...
	 *
	 * @param htmlIdRequest the new html id request
	 */
	 ...
	 *
	 * @param requestsTypes the new requests types
	 */
	 ...
	 *
	 * @param legateesTypes the new legatees types
	 */
	 ...
	 *
	 * @param vehiclesTypes the new vehicles types
	 */
	 ...
	 *
	 * @param requestsClasses the new requests classes
	 */
	 ...
	 *
	 * @param rqsDescripcion the new rqs descripcion
	 */
	 ...
	 *
	 * @param rqsCarnetEmpleado the new rqs carnet empleado
	 */
	 ...
	 *
	 * @param rqsCarnetAsignatario the new rqs carnet asignatario
	 */
	 ...
	 *
	 * @param rqsFechaInicial the new rqs fecha inicial
	 */
	 ...
	 *
	 * @param rqsFechaFinal the new rqs fecha final
	 */
	 ...
	 * Sets the coc numero.
	 *
	 * @param cocNumero the new coc numero
	 */
	 ...
	 *
	 * @param ccrPorcentaje the new ccr porcentaje
	 */
	 ...
	 * Sets the ccr valor.
	 *
	 * @param ccrValor the new ccr valor
	 */
	 ...
	 *
	 * @param ccrFechaInicio the new ccr fecha inicio
	 */
	 ...
	 *
	 * @param ccrFechaFin the new ccr fecha fin
	 */
	 ...
	 *
	 * @param messagePage the new message page
	 */
	 ...
	 * Sets the email asis.
	 *
	 * @param emailAsis the new email asis
	 */
	 ...
	 * Sets the email asig.
	 *
	 * @param emailAsig the new email asig
	 */
	 ...
	 *
	 * @param nombreAsis the new nombre asis
	 */
	 ...
	 *
	 * @param htmlSelectTipoAsig the new html select tipo asig
	 */
	 ...
	 *
	 * @param nombreTercero the new nombre tercero
	 */
	 ...
	 * Sets the txt placa.
	 *
	 * @param txtPlaca the new txt placa
	 */
	 ...
	 *
	 * @param showEmployees the new show employees
	 */
	 ...
	 * Sets the list users.
	 *
	 * @param listUsers the new list users
	 */
	 ...
	 *
	 * @param parametroBusquedad the new parametro busquedad
	 */
	 ...
	 *
	 * @param rowSelectorEvent the row selector event
	 */
	 ...
	 *
	 * @param opcFindEmpleado the new opc find empleado
	 */
	 ...
	 *
	 * @param porcentajeCentroCosto the new l porcentaje centro costo
	 */
	 ...
	 *
	 * @param showCostCentersTable the new show cost centers table
	 */
	 ...
	 *
	 * @param costCentersTable the new cost centers table
	 */
	 ...
	 *
	 * @param parametroCentroCostos the new parametro centro costos
	 */
	 ...
	 *
	 * @param idCostCenters the new id cost centers
	 */
	 ...
	 *
	 * @param idRequests the new id requests
	 */
	 ...
	 * Sets the id zones.
	 *
	 * @param idZones the new id zones
	 */
	 ...
	 * Sets the txt zona.
	 *
	 * @param txtZona the new txt zona
	 */
	 ...
	 * Sets the cbx zones.
	 *
	 * @param cbxZones the new cbx zones
	 */
	 ...
	 *
	 * @param showConfirmRequest the new show confirm request
	 */
	 ...
	 *
	 * @param showBtnCancelar the new show btn cancelar
	 */
	 ...
	 * Sets the show zones.
	 *
	 * @param showZones the new show zones
	 */
	 ...
	 * Validar datos.
	 *
	 * @param idRequestClasses the id request classes
	 * @param idResquestTypes the id resquest types
	 * @param idVehicleTypes the id vehicle types
	 * @param idLegateeTypes the id legatee types
	 ...
	 *
	 * @param htmlSelectRequestClass the new html select request class
	 */
	 ...
	 *
	 * @param showAuxiliaries the new show auxiliaries
	 */
	 ...
	 *
	 * @param idAuxiliares the new id auxiliares
	 */
	 ...
	 *
	 * @param cbxTipSolicitud the new cbx tip solicitud
	 */
	...
	public void opcPantallaTipoAsignacion(Long code) {
		...
		if (code.equals(ViewOptionUtil.OF) || code.equals(ViewOptionUtil.OFS)) {
			showOFS = true;
			showCostCenter = true;
			showZones = true;
			setShowZones(true);
	 ...
	 *
	 * @param disabledAsignacion the new disabled asignacion
	 */
	 ...
	 *
	 * @param listCostsCentersRequests the new list costs centers requests
	 */
	 ...
	 *
	 * @param txtCodCentroCosto the new txt cod centro costo
	 */
	 ...
	 *
	 * @param txtPorcentajeCentroCosto the new txt porcentaje centro costo
	 */
	 ...
	 *
	 * @param siscarNotNull the new siscar not null
	 */
	 ...
	 *
	 * @param confirmarSolicitud the new confirmar solicitud
	 */
	 ...
	 *
	 * @param advertenciaAlquiler the new advertencia alquiler
	 */
